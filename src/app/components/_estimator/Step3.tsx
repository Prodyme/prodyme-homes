                  ...
                  <div className="flex-col justify-start items-start inline-flex text-left">
                    ...
                    <div className="flex">
                      ...
                      {info.name === d.itemName && (
                        <div
                          className={`absolute z-50 font-normal bg-orange-50 mt-8 justify-center m-auto p-1 w-[400px]   max-xl:ml-[-25vw] max-sm:mx-2 max-sm:w-[90vw] max-sm:left-[2vw]  rounded-xl text-wrap ${(i + 1) % 3 === 0
