          ...
          {isMobile ? (
            <div>
              <div className="flex flex-col justify-center text-[12px] font-normal">
                <div>
                  <div className="text-[14px] md:text-xl font-normal text-white border-2 px-[30px] text-center py-5 border-orange-400">
                    Prodyme Logo and name
                  </div>
                </div>
                <div className="my-2">
            ...
            <div className="flex justify-between items-center">
              <div className="grid grid-cols-3">
                ...
                <div className="flex flex-col justify-between font-normal text-[14px]">
                  <div>
                    <h1 className="text-white border-2 px-[30px] text-center py-5 border-orange-400">
                      Prodyme Logo and name
                    </h1>
                  </div>
                  <div className="my-2">
