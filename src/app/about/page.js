    ...
    return (
        <div>
            <section className='section-1 py-5'>
                <div>
                    <h1 className='text-center font-bold text-3xl my-5'>About M&D Remodeling</h1>
                    <p className='text-center px-[410px] font-thin'>I'm a paragraph. Click here to add your own text and edit me. It’s easy. Just click “Edit Text” or double click me to add your own content and make changes to the font. Feel free to drag and drop me anywhere you like on your page. I’m a great place for you to tell a story and let your users know a little more about you.</p>
                </div>
            </section>
            ...
            <section className='section-3 py-5'>
                <div>
                    <h1 className='text-center font-bold text-3xl my-5'>Our Process</h1>
                    <p className='text-center  font-thin'>I'm a paragraph. Click here to add your own text and edit me. It’s easy.</p>
                    <p className='text-center  font-thin'>Just click “Edit Text” or double click me to add your own content and make changes to the font</p>
                </div>
            </section>
