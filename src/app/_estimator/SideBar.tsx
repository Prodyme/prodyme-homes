...
export const SideBar: React.FC<stepType> = ({ step, setStep })=> {
  return (
    <div className="mt-2 flex min-[1280px]:flex-col text-center ">
      ...
      >
        <div className="">Tentative area</div>
      ...
      <div
        className={
          step <= 2
            ? "w-[300px] max-xl:w-[30vw] h-[80px] px-5 py-6  min-[1280px]:rounded-bl-lg max-xl:rounded-r-lg justify-end items-start gap-2.5 inline-flex text-orange-400 text-xl max-sm:text-base font-normal font-['Anek Latin']"
            : step === 3
            ? "w-[300px] max-xl:w-[30vw] h-[80px] px-5 py-6 bg-orange-400  min-[1280px]:rounded-bl-lg max-xl:rounded-r-lg justify-end items-start gap-2.5 inline-flex text-white text-xl max-sm:text-base font-bold font-['Anek Latin']"
            : "w-[300px] max-xl:w-[30vw] h-[80px] px-5 py-6 bg-zinc-300  justify-end items-start gap-2.5 inline-flex text-black text-xl max-sm:text-base font-normal font-['Anek Latin']"
        }
      >
