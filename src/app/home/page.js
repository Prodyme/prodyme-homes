      ...
      <div>
            ...
            <div className="flex flex-col h-full justify-center items-center bg-[#EFEFEF] rounded-[50px]">
              ...
              <div className="px-5 py-3 ">
                <h1 className="text-[20px] font-bold">
                  Invest in <span className="text-[orange]">Proficiency</span>
                </h1>
                <p className="text-[16px] font-medium my-3">
                  Lorem ipsum dolor sit amet consectetur. Diam egestas volutpat
                  vulputate urna nisl at. Dignissim condimentum eget dignissim
                  vestibulum volutpat. Risus odio enim nam fermentum donec nisi
                  etiam amet at. Sed donec volutpat sagittis ultrices amet quam
                  feugiat malesuada pulvinar.
                </p>
                <div className="flex justify-center items-center">
                  <button
                    onClick={openModal1}
                    className="bg-white text-[orange] text-[16px] px-[30px] py-[8px] rounded-2xl"
                  >
            ...
            <div className="flex col-span-2 h-full bg-[#EFEFEF] rounded-[50px] items-center">
              <div className="w-[70%] max-w-[700px] h-auto mx-auto sm:w-full">
                <img
                  ...
                  alt="Person standing on a concrete slab"
                  className="h-auto w-full object-fill"
                />
              </div>
              <div className="px-10 py-5 ">
                <h1 className="text-[22px] xl:text-[32px] font-bold">
                  Invest in <span className="text-[orange]">Proficiency</span>
                </h1>
                ...
                <button
                  onClick={openModal1}
                  className="bg-white text-[orange] text-[12px] xl:text-[16px] px-[40px] py-[10px] rounded-2xl "
                >
                  Why our Quality is the best?
                </button>
              </div>
        ...
        `}
                ...
                <p className="mt-4">
                  ...
                  Eveniet atque harum, optio, ea magnam quod dolorem inventore
                  maiores hic officiis modi nulla dicta laudantium eos earum
                  voluptates id dolores blanditiis! Quasi dolorem maxime earum
                  officia quos cupiditate magni provident minus officiis dolore,
                  eveniet similique aliquam temporibus hic asperiores iusto
                  distinctio perferendis voluptas nobis alias iste consectetur,
                  expedita voluptates deleniti. Eum.
                </p>
                <img
                  src="https://images.unsplash.com/photo-1616610269931-04d58b579ddf?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bGFib3VyfGVufDB8fDB8fHww"
                  alt=""
        ...
        <section className="section-3 mx-5 md:mx-[71px] my-10">
          {isMobile ? (
            <div className="flex flex-col h-full justify-center items-center bg-[#EFEFEF] rounded-[50px]">
              ...
              <div className="px-5 py-3 ">
                <h1 className="text-[20px] font-bold">
                  Unmatched <span className="text-[orange]">Quality</span>
                </h1>
                <p className="text-[16px] font-medium my-3">
                  Lorem ipsum dolor sit amet consectetur. Diam egestas volutpat
                  vulputate urna nisl at. Dignissim condimentum eget dignissim
                ...
                <div className="flex justify-center items-center">
                  <button
                    onClick={isModalOpen2}
                    className="bg-white text-[orange] font-[16px] px-[30px] py-[8px] rounded-2xl "
                  >
                    Take a Glimpse!
                  </button>
                </div>
        ...
        <section className="section-4 mx-5 md:mx-[71px] my-10">
          {isMobile ? (
            <div className="flex flex-col h-full justify-center items-center bg-[#EFEFEF] rounded-[50px]">
              ...
              <div className="px-5 py-3 ">
                <h1 className="text-[20px] font-bold">
                  <span className="text-[orange]">Earthquake safe</span> in
                  Prodyme homes
                </h1>
                <p className="text-[16px] font-medium my-3">
                  Lorem ipsum dolor sit amet consectetur. Diam egestas volutpat
              ...
              <DialogTitle>
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-bold">
                    Earthquake safe in Prodyme homes
                  </h2>
        ...
        <section className="section-5 mx-5 md:mx-[71px] my-10">
          {isMobile ? (
            <div className="flex flex-col h-full justify-center items-center bg-[#EFEFEF] rounded-[50px]">
              ...
              <div className="px-5 py-3 ">
                <h1 className="text-[20px] font-bold">
                  Worry-Free <span className="text-[orange]">Warranty</span>of 2
                  Year
                </h1>
                <p className="text-[16px] font-medium my-3">
                  Lorem ipsum dolor sit amet consectetur. Diam egestas volutpat
